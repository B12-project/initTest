...
public enum SecurityErrorCode implements ErrorCode{
    ...
    EXPIRED_ACCESS_TOKEN(HttpStatus.BAD_REQUEST.value(), "만료된 액세스 토큰입니다. 토큰 재발급을 진행해주세요."),
    EXPIRED_REFRESH_TOKEN(HttpStatus.BAD_REQUEST.value(), "만료된 리프레쉬 토큰입니다. 다시 로그인해주세요."),
